...
const Standard = () => {
  return (
    <div className="text-xs border border-t-0 border-b-0 hover:border-t-4 hover:border-t-pink-400 transition ease-in duration-200 px-4">
      <p className="text-sm font-semibold py-4">Standard</p>
      <p className="opacity-50">
        Enjoy unlimited access with our standard browsing features.
      </p>
      <p className="py-8">
        <span className="font-semibold text-base">$89/</span> Billed annual
      </p>
